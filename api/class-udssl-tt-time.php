...
class UDSSL_TT_Time_Management{
    ...
    function get_time_slots(){
        ...
        foreach($timeslots as $timeslot){
            array_push($output, array(
                ...
                't_category' => $timeslot['t_category'],
                't_project' => $timeslot['t_project'],
                't_task' => $timeslot['t_task'],
                't_description' => $timeslot['t_description']
            ));
        }
    ...
    function add_time_slot(){
        ...
        $r = $udssl_tt->database->add_time_slot($input);
        if($r){
